...
<label for="user_type"> <b><h6 style="color:green" ></h6>{{ Auth::user()->Rank }} </h6></b></label>
<br>
@endif
                    <label for="user_type"> نوع الحساب  </label>
                    @if (Auth::user()->user_type=="Seller")
                    <b><h6 style="color:green">بائع</h6></b>
                    <label for="user_type">  <b><h6 style="color:green">الرتبة</h6></b>   </label>
                    <br>
                    @if(Auth::user()->Rank>=5)
                ...
                <b><h6 style="color:green">زبون</h6></b>
                <label for="user_type"> الرتبة   </label>
                @if(Auth::user()->Rank>=3 &&Auth::user()->Rank<=8)
                <label for="user_type"> مشتري مميز   </label>

                @elseif(Auth::user()->Rank>=9)
                <label for="user_type"> مشتري vip   </label>
                @else
            ...
            <b><h6 style="color:green">مدير الموقع</h6></b>
        @endif
            </div>
            </div>
            ...
            <div class="col-md-9 personal-info">
                ...
                <form action="{{ route("update_user_web") }}" method="POST" id="edit_user_form" enctype="multipart/form-data">
                    @csrf

...
<section>
    <h3 class="text-center text-primary mb-5"> تعديل عرض </h3>
    <form action="{{ route('update_offer') }} " method="post" id="add_property_form" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="city_name" id="city_name" value="{{ $property[0]->city_name }}" class="form-control"
            placeholder="المحافظة">
        <input type="hidden" class="form-control" value="{{ $property[0]->latitude }}" placeholder="lat" name="lat"
            id="lat">
        <input type="hidden" class="form-control" value="{{ $property[0]->longitude }}"placeholder="lng" name="lng"
            id="lng">
        <input type="hidden" id="seller_id" name="seller_id" value="{{ Auth::user()->id }}">
        <input type="hidden" name="offer_id" id="offer_id" value="{{ $offer[0]->id }}">
        ...
        <div class="modal-body p-4 bg-light">
            <div class="row">
                <div class="col-lg">
                    ...
                    <input type="text" id="area"name="area" class="form-control"
                        value="{{ $property[0]->area }}" placeholder="المساحة" required>
                </div>
                <div class="col-lg">
                    <label for="price">السعر</label>
                    <input type="text" id="price" name="price"
                        value="{{ $property[0]->price }}"class="form-control" placeholder="السعر">
                </div>
                <div class="col-lg">
                    <label for="price">السعر لليوم الواحد في حال الإيجار</label>
                    <input type="text" id="price_per_day"
                        value="{{ $property[0]->price_rent_per_day }}"name="price_per_day" class="form-control"
            ...
            <div class="row">
                <div class="col-lg">
                    ...
                    <input type="text" id="room_num"name="room_num"value="{{ $property[0]->room_num }}"
                        class="form-control" placeholder="عدد غرف النوم ">
                </div>
                <div class="col-lg">
                    <label for="storey">الطابق</label>
                    <input type="text" id="storey" name="storey" value="{{ $property[0]->storey }}"
                        class="form-control" placeholder="الطابق">
                </div>
                <div class="col-lg">
                    <label for="city_name">اسم المحافظة </label>
                    <input type="text" name="city_name1" value="{{ $property[0]->city_name }}"id="city_name1"
                        class="form-control" placeholder="المحافظة" disabled>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg">
                    ...
                    <input type="text" name="bath_num" id="bath_num"
                        value="{{ $property[0]->bath_num }}"class="form-control" placeholder=" عدد الحمامات">
                </div>
                <div class="col-lg">
                ...
                <div class="my-2">
                    ...
                    <textarea id="disc"name="disc" cols="166" rows="6">{{ $property[0]->disc }}</textarea>
                </div>
                <div class="col-lg">
            ...
            <div class="row mapform">
                <div class="col-lg">
                    ...
                    <input type="text" class="form-control"
                        value="{{ $property[0]->latitude }}"placeholder="lat" name="lat1" id="lat1"
                        disabled>
                </div>
                <div class="col-lg">
                    <label for="lng">خطوط الطول</label>
                    <input type="text" class="form-control" placeholder="lng"
                        value="{{ $property[0]->longitude }}"name="lng1" id="lng1" disabled>
                </div>
                <div class="col-lg">
        ...
        <div class="modal-footer">
            <button type="submit" id="add_property_btn" class="btn btn-primary">تعديل العرض </button>
        </div>
    </form>
    <form method="post" action="{{ route('delete_offer') }}">
        @csrf

        <input type="hidden" name="offer_id" id="offer_id" value="{{ $offer[0]->id }}">
        <div class="modal-footer">

            <button type="submit" id="add_property_btn" class="btn btn-danger">حذف العرض </button>
        </div>
    </form>
</section>
<script>
